...
RSpec.describe Computer, type: :feature do
    describe 'when I visit /computer_stores/:computer_stores:id/computers' do
        it 'shows each computer at the computer store' do 
            ...
            visit "/computerstores/#{store_1.id}/computers"
